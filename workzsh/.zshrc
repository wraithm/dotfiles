...
alias ecshell="emacsclient -s ~/.config/emacs/server/server -ct -e '(eshell t)'"
alias ghci-core='stack ghci --ghci-options="-ddump-simpl -dsuppress-idinfo \
    -dsuppress-coercions -dsuppress-type-applications \
    -dsuppress-uniques -dsuppress-module-prefixes"'
alias ec='emacsclient -s ~/.config/emacs/server/server -ct'
alias ecf='emacsclient -s ~/.config/emacs/server/server -c -n'
...
# export VAULT_CACERT=$HOME/.bitnomial/exchange-ca.pem
